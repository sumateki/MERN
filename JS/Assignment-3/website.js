...
var cloth_cont = document.getElementById('cloth_cont') 
var cloth_sec = document.getElementById('clothing')
var accessories_sec= document.getElementById('accessories')

// var cloth_head = document.createElement('h1')
// cloth_head.innerHTML = 'Clothing for Men and Women'
// cloth_cont.append(cloth_head)
...
//   card.append(image_sec,text_sec)// appending to card sec
...
//   text_sec.append(title, brand, price) //appending to text_sec


// ----------------------------- way 2 -------------------------------
card.innerHTML= `<img src= "${productList[i].preview}" alt="${productList[i].name}">
<div class="text_sec">
<h3 class="heading">${productList[i].name} </h3>
...
<span>Rs ${productList[i].price}</span> 
  ...
  if(productList[i].isAccessory === true){
    ...
    // document.write(productList.id,"<br>",productList.name,"<br>",productList.preview,"<br>",productList.photos,"<br>",productList.description,"<br>",productList.size,"<br>",productList.isAccessory,"<br>",productList.brand,"<br>",productList.price,"<br>")
    // for(var i=0; i<productList.length; i++){
    //     // document.write(productList[i].name)
    //     for(var j in productList[i]){

    //         document.write(productList[i][j])
    //     }
    // }
