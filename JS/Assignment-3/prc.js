...
// var cloth_cont= document.getElementById('cloth_content')
var cloth_sec = document.getElementById('clothing')
var accessory_sec = document.getElementById('accessory')
...
for(var i=0; i<prdlist.length; i++){
    ...
    image_sec.src = prdlist[i].preview

    var txt_sec = document.createElement('div')
    card.append(image_sec, txt_sec)

    var title = document.createElement('h3')
    title.id = 'heading'
    title.innerText = prdlist[i].name
    var brand = document.createElement('p')
    brand.innerText = prdlist[i].brand
    var price = document.createElement('span')
    price.innerText = prdlist[i].price
    txt_sec.append(title, brand, price)

    


    if(prdlist[i].isAccessory === true){
        accessory_sec.append(card)
    }
    else{
