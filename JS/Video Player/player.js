...
function createPlaylistCard(obj, pos) {
    ...
    mainDiv.appendChild(title);
     ...
     //add click event listener to the crd to load the video
     mainDiv.addEventListener('click', function(){
        createVideoPlayer(videoPlaySectionData[pos])

        //remove the 'active-card' cls from all cards
        var playlistCards = document.querySelectorAll('.playlist-card')
        playlistCards.forEach(function(card){
            card.classList.remove('active-card')
        })
        //add the 'active-card' cls to the clicked card
...
function createVideoPlayer(videoData) {
    ...
    if (videoData && videoData.vimeoId) {
        ...
        console.error('Invalid Vimeo video data. The Vimeo video ID is missing or invalid.');
    }
}


// Add this line to ensure the DOM is fully loaded before executing the code
document.addEventListener('DOMContentLoaded', function() {
    ...
    playlistCards.forEach(function(card, index){
        card.addEventListener('click', function(){
            //get the corresponding video data from videoPlaySectionData
            var videoData = videoPlaySectionData[index]
    
            //create the video player with the selected video data
            ...
            //add the 'active-card' class to the clicked card
...
// //function to create playlist card with thumbnail and title
// function createPlaylistCard(obj, pos) {
...
//      var videoPlayer = document.getElementById('video-player')
//     if(videoData && videoData.vimeoId){
//          //set the source of iframe to the vimeo video url
//      videoPlayer.src = 'https://player.vimeo.com/video/' + videoData.vimeoId;
